...
echo ${base64encode(file("../../Modules/ec2/install-script-npp.ps1"))} > tmp1.b64 && certutil -decode tmp1.b64 install-script-npp.ps1
echo ${base64encode(file("../../Modules/ec2/install-script-Java.ps1"))} > tmp1.b64 && certutil -decode tmp1.b64 install-script-Java.ps1
